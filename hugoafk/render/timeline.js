...
const TL = {
  ...
  fx(t, fx) {
    ...
    if ((t >= 12 && t < 15) || (t >= 17 && t < 20) || (t >= 23 && t < 25.85)) fx.scan = Math.max(fx.scan, 0.035);
...
TL.add('s06', 15.0, 17.0, { src: [15.0, 17.5] });   // 2.5 s of content in 2.0 s
TL.add('s07', 17.0, 20.0, { src: [17.5, 20.5] });   // pure shift
...
TL.transitions.push(
  ...
  { at: 17.0, type: ['punch', 'rgb'], punch: 0.05, amount: 10, dur: 0.14, shake: 3 },
